...
export const GroupItem = ({ group, gp, go, active, compactMode, verticalTabs, s }: any) => (
  <div className={`flex transition-all select-none ${verticalTabs ? 'flex-col w-full' : 'items-center h-full'} ${compactMode ? 'bg-gray-100/80 border-r border-gray-200' : 'bg-gray-100 border border-gray-200/50 p-1 rounded-xl self-center gap-1 shadow-sm'}`}>
    <div 
