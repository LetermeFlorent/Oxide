  ...
  return (
    <ModalLayout show={show} z={5000}>
      <div className="flex items-center gap-3 mb-6">
        <div className="w-10 h-10 rounded-[12px] flex items-center justify-center bg-sidebar-bg text-gray-500">
          <Library size={20} />
        </div>
        <div>
          <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground/40 mb-0.5">New Group</h3>
          <p className="text-[13px] font-bold text-foreground leading-none">Categorize your items</p>
        </div>
      </div>
      <ModalInput 
        autoFocus 
