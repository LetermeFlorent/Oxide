...
export const WorkspaceView = memo(({ id, project, projects, overviews, showPre, isTerm, startTerm, onOpen }: any) => {
  ...
  return (
    <div className="flex-1 flex flex-row overflow-hidden relative">
      ...
      <div style={{ width: (showPre && !isTerm) ? 'var(--terminal-w)' : '100%' }} className="h-full shrink-0 min-w-0 flex relative">
