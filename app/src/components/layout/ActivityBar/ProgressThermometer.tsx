...
export const ProgressThermometer = memo(({ progress, showBar, showPercent }: ProgressThermometerProps) => (
  <AnimatePresence>
    {progress !== null && (showBar || showPercent) && (
      ...
      >
        {showBar && (
          <div className="relative w-1.5 h-32 bg-sidebar-bg rounded-full overflow-hidden shadow-[inset:0_1px_2px_rgba(0,0,0,0.05)]">
        ...
        <div className="flex flex-col items-center">
          {showPercent && <span className="text-[8px] font-black text-orange-500 tracking-tighter leading-none">{progress}%</span>}
          {showBar && (
