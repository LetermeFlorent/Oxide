  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center fade-in pointer-events-none">
      <div className="flex flex-col items-center gap-6 max-w-sm w-full pointer-events-auto">
        <div className={`w-20 h-20 bg-sidebar-bg flex items-center justify-center ${rd}`}>
        ...
        <button onClick={onOpen} className={`w-full flex items-center justify-center gap-2 px-6 py-3 bg-foreground text-background text-[10px] font-black uppercase tracking-[0.1em] hover:opacity-90 transition-all active:scale-95 ${brd}`}>
