...
export const ContextMenuItem = memo(({ onClick, icon: Icon, label, variant = 'default' }: { onClick: () => void, icon: LucideIcon, label: string, variant?: 'default' | 'danger' | 'primary' }) => {
  const styles = {
    default: "text-foreground/60 hover:bg-sidebar-bg",
    danger: "text-red-500 hover:bg-red-50",
    primary: "text-foreground hover:bg-sidebar-bg"
  };
  return (
...
export const ContextMenuSeparator = memo(() => <div className="h-px bg-sidebar-bg my-1" />);
