...
export interface TabProps {
  active: boolean; onClick: () => void; onDoubleClick?: () => void; icon: any; label: string; 
  activeClass: string; disabled?: boolean;
}

export const TerminalTab = memo(({ active, onClick, onDoubleClick, icon: Icon, label, activeClass, disabled }: TabProps) => (
  <button
