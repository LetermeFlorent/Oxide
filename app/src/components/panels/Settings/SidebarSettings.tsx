...
export const SidebarSettings = memo(({ state, setSetting }: any) => (
  <section className="space-y-4">
    <div className="flex items-center gap-2"><Layout size={12} className="text-foreground/40" /><h3 className="text-[9px] font-black uppercase tracking-widest text-foreground/40">{t('settings.display')}</h3></div>
