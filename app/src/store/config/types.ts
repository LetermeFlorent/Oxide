...
export interface WorkspaceState {
  ...
  showExplorer: boolean; showPreview: boolean; showSettings: boolean; showSearch: boolean;
  ...
  setProjects: (projects: ProjectSession[]) => void;
  setTerminalOverviews: (overviews: TerminalOverview[]) => void;
